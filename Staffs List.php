...
<body>
    ...
    <section class="bg-body-secondary">
        <div class="row g-4">
            <h1 class="text-center font-arial-black"><b><u>OUR STAFFS</u></b></h1>
            <div class="table-responsive">
                <table class="table table-bordered table-striped text-center">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th>RESPONSIBLITY</th>
                            <th>ADHAAR_NUMBER</th>
                            <th>MATRIC_PERCENTAGE</th>
                            <th>INTERMEDIATE_PERCENTAGE</th>
                            <th>OTHER_DEGREES</th>
                            <th>JOINED_DATE</th>
                            <th>USER_NAME</th>
                            <th>PASSWORD</th>
                    ...
                    <tbody>
                       ...
                       ?>
                        <tr>
                            ...
                            <td><?php echo $row['intermediate_percentage']; ?></td>
                            <td><?php echo $row['other_degrees']; ?></td>
                ...
                <a href="http://localhost/Charak%20Seva%20Hospital/Add%20Staff.html" class="btn btn-secondary w-50" 
