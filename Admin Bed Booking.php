...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action'], $_POST['id'])) {
    ...
    if ($action == 'approve') {
        ...
        $query = "DELETE FROM bed_booking WHERE sr_no='$id'";
    }
...
<head>
    ...
    <title>BED BOOKING REQUEST LIST</title>
...
<body>
    ...
    <section class="bg-body-secondary">
        <div class="row g-4">
            <h1 class="text-center font-arial-black"><b><u>BED BOOKING REQUEST LIST</u></b></h1>
