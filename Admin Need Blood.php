...
<body>
    ...
    <section class="bg-body-secondary">
        <div class="row g-4">
            <h1 class="text-center font-arial-black"><b><u>BLOOD REQUESTS LIST</u></b></h1>
                       ...
                       ?>
                        <tr>
                           ...
                           <!-- <td>
                            ...
                            <td><button class="btn btn-success btn-sm">ARRANGE</button></td>
                            <td><button class="btn btn-secondary btn-sm">DECLINE</button></td>
